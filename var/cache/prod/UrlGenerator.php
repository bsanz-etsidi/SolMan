...
return [
    ...
    'otroDestino' => [['emailcrypt', 'id'], ['_controller' => 'App\\Controller\\DefaultController::otroDestinoAction'], [], [['variable', '/', '[^/]++', 'id'], ['variable', '/', '[^/]++', 'emailcrypt'], ['text', '/otroDestino']], [], []],
    'mensajeNoPuede' => [[], ['_controller' => 'App\\Controller\\DefaultController::mensajeNoPuedeAction'], [], [['text', '/mensajeNoPuede']], [], []],
    'mensaje' => [['emailcrypt'], ['_controller' => 'App\\Controller\\DefaultController::mensajeAction'], ['emailcrypt' => '.+'], [['variable', '/', '.+', 'emailcrypt'], ['text', '/mensaje']], [], []],
    ...
    'rellenarSatisfaccion' => [['id', 'email'], ['_controller' => 'App\\Controller\\DefaultController::rellenarSatisfaccionAction'], ['id' => '.+'], [['variable', '/', '[^/]++', 'email'], ['variable', '/', '.+', 'id'], ['text', '/rellenarSatisfaccion']], [], []],
