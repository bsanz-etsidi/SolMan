 ...
 */
class Parte extends \App\Entity\Parte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'localizacion', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'fechainicio', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'fechafin', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'descripcion', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'solicitud', '' . "\0" . 'App\\Entity\\Parte' . "\0" . 'especialidades'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Parte $proxy) {
    ...
    public function addEspecialidad(\App\Entity\Especialidad $especialidad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEspecialidad', [$especialidad]);
    ...
    public function removeEspecialidad(\App\Entity\Especialidad $especialidad)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEspecialidad', [$especialidad]);

        return parent::removeEspecialidad($especialidad);
    }

    /**
     * {@inheritDoc}
     */
    public function getEspecialidades(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEspecialidades', []);
