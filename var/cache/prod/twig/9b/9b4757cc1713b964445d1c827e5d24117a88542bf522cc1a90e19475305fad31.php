...
class __TwigTemplate_8e89bb8bf9e258c33434e3ac868532f533dd38cf21c8f7f54e1d812d03457125 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        ...
        ";
        // line 101
        if (1 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [], "any", false, false, false, 101), 0)) {
            // line 102
...
";
    ...
    ";
        // line 132
        if ((0 === twig_compare(($context["profiler_markup_version"] ?? null), 1) || 1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "mailers", [], "any", false, false, false, 132)), 1))) {
            // line 133
            echo "        <table>
            <thead>
                <tr>
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
                ...
                echo " ";
                echo ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "messageCount", [0 => $context["name"]], "method", false, false, false, 158), 1)) ? ("message") : ("messages"));
                echo "</span>
                </div>
            ";
            }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            // line 165
            echo "        ";
            if (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "mailers", [], "any", false, false, false, 165)), 1)) {
                // line 166
                echo "            <h3>
                ";
                // line 167
                    ...
                    if (($context["attachments"] ?? null)) {
                        ...
                        echo "                        <div class=\"card-block\">
                            <span class=\"label\">
                                ";
                        // line 250
                        if (1 === twig_compare(twig_length_filter($this->env, ($context["attachments"] ?? null)), 1)) {
                            // line 251
                            echo "                                    ";
