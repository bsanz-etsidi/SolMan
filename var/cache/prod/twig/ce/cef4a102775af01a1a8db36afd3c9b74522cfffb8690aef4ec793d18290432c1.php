...
class __TwigTemplate_2e8068783f88976e34dd898465d3f750881edcb82d00d6d2fcafaefb3c03afb5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"trace-details\">
        ...
        // line 11
        echo ((1 === twig_compare(twig_length_filter($this->env, twig_split_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["exception"] ?? null), "class", [], "any", false, false, false, 11), "\\")), 1)) ? ("\\") : (""));
        echo "
                    </span>
                    ";
        // line 13
        ...
        echo "
                ...
                ";
        // line 16
        if (( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["exception"] ?? null), "message", [], "any", false, false, false, 16)) && 1 === twig_compare(($context["index"] ?? null), 1))) {
            // line 17
...
";
    ...
    {
        return new Source("", "@Twig/Exception/traces.html.twig", "C:\\symfony4REMOTO\\SolMan\\vendor\\symfony\\twig-bundle\\Resources\\views\\Exception\\traces.html.twig");
    }
}
