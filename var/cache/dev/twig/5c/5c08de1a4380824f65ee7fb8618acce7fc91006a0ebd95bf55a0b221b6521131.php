...
";
    ...
    public function block_titulo($context, array $blocks = [])
    {
        ...
        echo "MANTENIMIENTO-ETSIDI Anular Solicitud";
        ...
        echo "
                    ...
                    <tr>
                      <td>
                        ...
                        ";
        // line 117
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 117, $this->source); })()), "Anular", [], "any", false, false, false, 117), 'label');
        echo "

                        ";
        // line 119
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 119, $this->source); })()), "Anular", [], "any", false, false, false, 119), 'widget');
        echo "
                        <div style=\"line-height:75%;\">
                          <br />
...
{#TITULO#}
<title>{% block titulo %}MANTENIMIENTO-ETSIDI Anular Solicitud{% endblock %}</title>
{#Contenido#}
{% block contenido %}
<html>
      ...
      <div class=\"text-center justify-content-md-center\" style=\"margin-top:60px;\">
        <div class=\"col-lg-12 justify-content-md-center\">
          ...
          <div>
            <div style=\"margin-top:75px\">
              <h1 class=\"mt-4 mb-3 text-danger\" style=\"font-family: Saira Extra Condensed;\">
                ANULAR LA SOLICITUD <a href=\"{{path('solicitud',{'idcrypt':solicitud.idcrypt,'id':solicitud.id})}}\" style=\"color: black;\">{{solicitud.id}}</a></small>
              </h1>
            </div>
                  ...
                  <table align=\"center\">
                    ...
                    <tr>
                      <td>
                        ...
                        {{ form_label(form.Anular) }}

                        {{ form_widget(form.Anular)}}
                        <div style=\"line-height:75%;\">
                          <br />
...
</html>", "gestionMantenimiento/anularSolicitud.html.twig", "C:\\symfony4REMOTO\\SolMan\\templates\\gestionMantenimiento\\anularSolicitud.html.twig");
    }
}
