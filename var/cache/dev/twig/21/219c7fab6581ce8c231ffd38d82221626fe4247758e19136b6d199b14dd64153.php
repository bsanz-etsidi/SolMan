...
class __TwigTemplate_b39bd431f276cd0f77ea025b79183a1228aca4339e23ac2bb3e60e36c19817dd extends Template
{
    private $source;
    private $macros = [];
  ...
  <div style=\"margin-top:75px\">
    ...
    <div id=\"content\">
      <div class=\"row\">
        ...
        echo "</small></h3>
          <h3 class=\"my-3\">Grado de satisfacción por parte del solicitante (0 a 10): <small>";
        // line 34
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["parte"]) || array_key_exists("parte", $context) ? $context["parte"] : (function () { throw new RuntimeError('Variable "parte" does not exist.', 34, $this->source); })()), "satisfaccion", [], "any", false, false, false, 34), "html", null, true);
        echo "</small></h3>
          <h3 class=\"my-3\">Observaciones del solicitante: <small>";
        // line 35
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["parte"]) || array_key_exists("parte", $context) ? $context["parte"] : (function () { throw new RuntimeError('Variable "parte" does not exist.', 35, $this->source); })()), "observaciones", [], "any", false, false, false, 35), "html", null, true);
        echo "</small></h3>
...
";
    ...
    {
        return array (  195 => 58,  185 => 57,  153 => 35,  149 => 34,  145 => 33,  141 => 32,  136 => 31,  127 => 29,  123 => 28,  118 => 26,  114 => 25,  109 => 23,  104 => 21,  91 => 10,  81 => 9,  70 => 5,  60 => 4,  37 => 2,);
    }
    ...
    <div id=\"content\">
      <div class=\"row\">
        ...
        <div class=\"col-lg-20\">
          ...
          <h3 class=\"my-3\">Grado de satisfacción por parte del solicitante (0 a 10): <small>{{parte.satisfaccion}}</small></h3>
          <h3 class=\"my-3\">Observaciones del solicitante: <small>{{parte.observaciones}}</small></h3>
...
{% endblock %}
", "gestionMantenimiento/parte.html.twig", "C:\\symfony4\\SolMan\\templates\\gestionMantenimiento\\parte.html.twig");
    }
}
