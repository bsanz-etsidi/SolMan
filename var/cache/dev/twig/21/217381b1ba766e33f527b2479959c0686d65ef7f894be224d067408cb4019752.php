...
class __TwigTemplate_7750fa88636d56ef55354740beb3152a85ebcf7faa5ee84536dab560074b53b4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"content\">
      <div class=\"row\">
        ...
        <div class=\"col-lg-20\">
          ...
          <h3 class=\"my-3\"><small>{{trabajador.nombre}}</small></h3>
          {% endfor %}
          {% else %}
...
{% endblock %}
", "gestionMantenimiento/solicitud.html.twig", "C:\\symfony4\\SolMan\\templates\\gestionMantenimiento\\solicitud.html.twig");
    }
}
