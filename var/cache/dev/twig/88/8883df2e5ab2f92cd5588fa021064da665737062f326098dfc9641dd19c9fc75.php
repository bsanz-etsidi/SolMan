...
class __TwigTemplate_19986852b30ae3d26db30e47ba922cca276177d4d812a91ff6827deaba13bd48 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 2
        $this->parent = $this->loadTemplate("frontal/base.html.twig", "gestionMantenimiento/editarInstruccion.html.twig", 2);
...
<div class=\"container\">
  ...
  <div style=\"margin-top:75px\">
    <h1 class=\" mt-4 mb-3\"> Mantenimiento
      <small>Modificar o dar por completadas las instrucciones para la solicitud <a href=\"";
        // line 16
        ...
        echo twig_escape_filter($this->env, (isset($context["nombreTrabajador"]) || array_key_exists("nombreTrabajador", $context) ? $context["nombreTrabajador"] : (function () { throw new RuntimeError('Variable "nombreTrabajador" does not exist.', 16, $this->source); })()), "html", null, true);
        echo "</small>
    </h1>
  </div>
...
";
    ...
    {
        return array (  137 => 37,  127 => 30,  123 => 29,  119 => 28,  100 => 16,  91 => 9,  81 => 8,  62 => 6,  51 => 2,  49 => 3,  36 => 2,);
    }
...
<div class=\"container\">
  ...
  <div style=\"margin-top:75px\">
    <h1 class=\" mt-4 mb-3\"> Mantenimiento
      <small>Modificar o dar por completadas las instrucciones para la solicitud <a href=\"{{path('solicitud',{'id':solicitud.id})}}\">{{solicitud.id}}</a> al trabajador: {{nombreTrabajador}}</small>
    </h1>
  </div>
  ...
  <div style=\"margin-bottom:75px\">
    ...
    <div style=\"margin-top:10px\">
      <a class=\"btn btn-primary\" style=\"background-color:#C3C3C3;border: #000;background: -moz-linear-gradient(center top , #C0C0C0 0%, #808080 100%) repeat scroll 0 0 transparent;background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #C0C0C0), color-stop(100%,#808080));
            box-shadow: 1px 1px 1px grey\" href=\"{{ path('completarInstruccion',{'instruccionId':idInstruccion}) }}\" role=\"button\"> Completadas </a>
    </div>
  </div>
</div>
