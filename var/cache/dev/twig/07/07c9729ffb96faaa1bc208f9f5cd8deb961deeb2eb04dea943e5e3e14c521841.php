  ...
  <div style=\"margin-top:75px\">
    <h1 class=\" mt-4 mb-3\"> Mantenimiento
      <small>Seleccione las especialidades requeridas en los trabajos correspondientes al parte <a href=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("parte", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["parte"]) || array_key_exists("parte", $context) ? $context["parte"] : (function () { throw new RuntimeError('Variable "parte" does not exist.', 16, $this->source); })()), "id", [], "any", false, false, false, 16)]), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["parte"]) || array_key_exists("parte", $context) ? $context["parte"] : (function () { throw new RuntimeError('Variable "parte" does not exist.', 16, $this->source); })()), "id", [], "any", false, false, false, 16), "html", null, true);
        echo "</a></small>
    </h1>
  </div>
...
<div class=\"container\">
  ...
  <div style=\"margin-top:75px\">
    <h1 class=\" mt-4 mb-3\"> Mantenimiento
      <small>Seleccione las especialidades requeridas en los trabajos correspondientes al parte <a href=\"{{path('parte',{'id':parte.id})}}\">{{parte.id}}</a></small>
    </h1>
  </div>
  ...
  <div style=\"margin-bottom:75px\">
    ...
    <div style=\"margin-top:10px\">
      <a class=\"btn btn-primary\" style=\"background-color:#C3C3C3;border: #000;background: -moz-linear-gradient(center top , #C0C0C0 0%, #808080 100%) repeat scroll 0 0 transparent;background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #C0C0C0), color-stop(100%,#808080));
            box-shadow: 1px 1px 1px grey\" href=\"{{ path('partes') }}\" role=\"button\"> Volver </a>
    </div>
  </div>
</div>
